...
type TLoadingState = Set<string>
const logoSize = 50


export const LoaderProvider = ({ children }: { children: ReactNode }) => {
  const [loadingSet, setLoadingSet] = useState<TLoadingState>(new Set());
...
const LoaderSpinner = () => {
  ...
  return <motion.div
    ...
    >
      {(mounted && resolvedTheme === "light") ? <LogoIconBlack width={logoSize} height={logoSize} /> : <LogoIconWhite width={logoSize} height={logoSize} />}
    </motion.div>
  </motion.div>
}
