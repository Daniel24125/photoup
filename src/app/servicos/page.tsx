    ...
    >
      <div className='w-full max-w-xl backdrop-blur-md p-10 gap-5 z-10 text-center flex flex-col items-center'>
        ...
        <p className="text-white ">
          {language === "EN" ? "Our services are still growing and we are working hard to offer the best solutions.": "Os nossos serviços ainda estão a crescer e estamos a trabalhar afincadamente para oferecer as melhores soluções."}
        </p>
